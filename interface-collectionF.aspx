<%@ Page Title="我的論帖收藏" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="interface-collectionF.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="button">
    ...
    <div class="collection-type" style="line-height:50px;padding-left:200px">
         <div class="title">          
             <asp:label runat="server" Font-Bold="True">論帖收藏</asp:label>   
         </div>         
          <div>

              <asp:ListView ID="ListView1" runat="server" DataKeyNames="CollectFID" DataSourceID="SqlDataSource1" GroupItemCount="6">
                  <AlternatingItemTemplate>
                      <td runat="server" style="background-color: #FFFFFF;color: #284775;">
                            <asp:ImageButton ID="ImageButton1" runat="server" Height="100px" Width="150px" ImageUrl='<%# "img/"+Eval("ForumPhoto") %>' OnClick="ImageButton1_Click"/>
                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("FID") %>' Visible="false" />
                          <br />
                          <asp:Label ID="Label1" runat="server"  Text='<%# Eval("ForumName") %>'></asp:Label>
                          <asp:Button ID="Button4" runat="server"  BackColor="Black"  BorderStyle="Ridge"  Font-Names="微軟正黑體" Font-Size="12pt" ForeColor="White" onmouseover="this.style.fontWeight='bold'"  onmouseout="this.style.fontWeight=''" Text="移除" OnClick="Button4_Click" OnClientClick="return confirm('確定要刪除嗎？')"/>                           <br />
                      </td>
                  </AlternatingItemTemplate>
                  <EditItemTemplate>
                      <td runat="server" style="background-color: #999999;">CollectFID:
                          <asp:Label ID="CollectFIDLabel1" runat="server" Text='<%# Eval("CollectFID") %>' />
                          <br />Remarks:
...
<td runat="server" />
                  ...
                  <InsertItemTemplate>
                      <td runat="server" style="">CollectFID:
                          <asp:TextBox ID="CollectFIDTextBox" runat="server" Text='<%# Bind("CollectFID") %>' />
                          <br />Remarks:
                          <asp:TextBox ID="RemarksTextBox" runat="server" Text='<%# Bind("Remarks") %>' />
                          <br />Time:
                          <asp:TextBox ID="TimeTextBox" runat="server" Text='<%# Bind("Time") %>' />
                  ...
                  <SelectedItemTemplate>
                      <td runat="server" style="background-color: #E2DED6;font-weight: bold;color: #333333;">CollectFID:
                          <asp:Label ID="CollectFIDLabel" runat="server" Text='<%# Eval("CollectFID") %>' />
                          <br />Remarks:
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [CollectForum]"></asp:SqlDataSource>
