<%@ Page Title="我的黑名單" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Interface-blacklist.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="button">
    ...
    <div style="padding-left:200px">
          <div class="title">          
             <asp:label runat="server" Font-Bold="True">我的黑名單</asp:label>   
         </div>    
              <div>
                  <asp:ListView ID="ListView1" runat="server" DataKeyNames="BlacklistID" DataSourceID="SqlDataSource1" GroupItemCount="3">
                      <AlternatingItemTemplate>
                          <td runat="server" style="background-color: #FFFFFF;color: #284775;">
                              ...
                              <asp:Label ID="Label1" runat="server" Text='<%# Eval("MemberName") %>'></asp:Label>
                               <asp:Label ID="Label3" runat="server" Text='<%# Eval("MemberID") %>'></asp:Label>
                              <asp:Button ID="Button4" runat="server" BackColor="Black"  BorderStyle="Ridge"  Font-Names="微軟正黑體" Font-Size="12pt" ForeColor="White" onmouseover="this.style.fontWeight='bold'"  onmouseout="this.style.fontWeight=''" Text="移除" OnClientClick="return confirm('確定要移除嗎？')"/>
  
                              <br /></td>
                      </AlternatingItemTemplate>
                      <EditItemTemplate>
                          <td runat="server" style="background-color: #999999;">BlacklistID:
                              <asp:Label ID="BlacklistIDLabel1" runat="server" Text='<%# Eval("BlacklistID") %>' />
                              <br />Remarks:
...
<td runat="server" />
                      ...
                      <InsertItemTemplate>
                          <td runat="server" style="">BlacklistID:
                              <asp:TextBox ID="BlacklistIDTextBox" runat="server" Text='<%# Bind("BlacklistID") %>' />
                              <br />Remarks:
                              <asp:TextBox ID="RemarksTextBox" runat="server" Text='<%# Bind("Remarks") %>' />
                              <br />Time:
                              <asp:TextBox ID="TimeTextBox" runat="server" Text='<%# Bind("Time") %>' />
                      ...
                      <ItemTemplate>
                          <td runat="server" style="background-color: #E0FFFF;color: #333333;">
                               <asp:ImageButton ID="ImageButton1" runat="server" Height="50px" Width="55px" ImageUrl='<%# "img/"+Eval("MemberPhoto") %>'  OnClick="ImageButton1_Click"/>
                              <asp:Label ID="Label2" runat="server" Text='<%# Eval("MemberName") %>'></asp:Label>
                              <asp:Label ID="Label3" runat="server" Text='<%# Eval("MemberID") %>'></asp:Label>
                              <asp:Button ID="Button5" runat="server" BackColor="Black"  BorderStyle="Ridge"  Font-Names="微軟正黑體" Font-Size="12pt" ForeColor="White" onmouseover="this.style.fontWeight='bold'"  onmouseout="this.style.fontWeight=''" Text="移除" OnClientClick="return confirm('確定要移除嗎？')"/>
                      ...
                      <SelectedItemTemplate>
                          <td runat="server" style="background-color: #E2DED6;font-weight: bold;color: #333333;">BlacklistID:
                              <asp:Label ID="BlacklistIDLabel" runat="server" Text='<%# Eval("BlacklistID") %>' />
                              <br />Remarks:
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Blacklist]"></asp:SqlDataSource>
    </div>
