<%@ Page Title="案件內容" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Case-血鎮information.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="center" style="padding-top:50px;padding-bottom:150px;line-height:50px;font-family:'微軟正黑體';width:900px">
         <tr > <td rowspan="6"> <asp:Image ID="Image1" runat="server" Height="273px" Width="253px"  /> </td> </tr>
        <tr>
            ...
            <td>
             ...
             <td><asp:Button ID="Button4" runat="server" Text="申請加入"  BackColor="Black"  BorderStyle="Ridge"  Font-Names="微軟正黑體" Font-Size="12pt" ForeColor="White" onmouseover="this.style.fontWeight='bold'"  onmouseout="this.style.fontWeight=''" OnClick="Button4_Click" />  </td>
        </tr>
        <tr>
            <td class="auto-style7">
                <asp:Label ID="Label3" runat="server" Text="風格:"></asp:Label>
            </td>
            <td class="auto-style7">
                <asp:Label ID="Label4" runat="server" ></asp:Label></td>
             <td><asp:Button ID="Button1" runat="server"  BackColor="Black"  BorderStyle="Ridge"  Font-Names="微軟正黑體" Font-Size="12pt" ForeColor="White" onmouseover="this.style.fontWeight='bold'"  onmouseout="this.style.fontWeight=''" Text="收藏案件" OnClick="Button1_Click" />  </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label7" runat="server" Text="Label">類型:</asp:Label>
            </td>
            <td>
                <asp:Label ID="Label5" runat="server" ></asp:Label> </td>
             <td><asp:Button ID="Button2" runat="server" Text="管理案件"  BackColor="Black"  BorderStyle="Ridge"  Font-Names="微軟正黑體" Font-Size="12pt" ForeColor="White" onmouseover="this.style.fontWeight='bold'"  onmouseout="this.style.fontWeight=''" OnClick="Button2_Click"  />  </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label8" runat="server" Text="Label">發布人:</asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label11" runat="server" Text="Label">招募:</asp:Label>
            </td>
            <td>
    ...
    <hr />
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="MessageCaseID" DataSourceID="SqlDataSource1">
        ...
        <EditItemTemplate>
            ...
            <br />
            MessageCaseID:
            <asp:Label ID="MessageCaseIDLabel1" runat="server" Text='<%# Eval("MessageCaseID") %>' />
            <br />
            TextContent:
        ...
        <SelectedItemTemplate>
            ...
            <br />
            MessageCaseID:
            <asp:Label ID="MessageCaseIDLabel" runat="server" Text='<%# Eval("MessageCaseID") %>' />
            <br />
            TextContent:
            <asp:Label ID="TextContentLabel" runat="server" Text='<%# Eval("TextContent") %>' />
            <br />
